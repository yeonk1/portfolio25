    ...
    const projects = [
        {
            ...
            desc: "스포츠 트래킹 & 커머스 통합 모바일 앱 어플리케이션 구축건입니다. UI 구축으로 단독 참여 프로젝트이고, 프론트 개발자들과 적극적인 소통과함께 MODAL, INPUT, BUTTON 등 모든 디자인 시스템을 기반한 컴포넌트 구축을 진행하였습니다. 쇼핑과 더불어 운동 시스템까지 많은 케이스들을 구현할 수 있었던 프로젝트입니다.",
            image: 'portfoilo.jpg'
        },
        {
            ...
            desc: "유학, 교육 커머스 어플리케이션 구축건입니다. UI 부분 단독 참여했습니다. 데이터 흐름을 이해하고, 모든 CASE가 대비될 수 있는 레이아웃을 설계했습니다. 특히, 샌드버드 채팅 프레임워크 커스텀까지 작업하여 서비스의 완성도를 높였습니다.",
